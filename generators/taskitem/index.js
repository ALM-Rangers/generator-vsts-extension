...
function input() {
      ...
      return this.prompt([
            ...
            },
            {
                  ...
                  validate: util.validateTaskScripting,
                  when: answers => {
            ...
            },
            {
                  ...
                  this.taskScripting = util.reconcileValue(a.taskScripting, cmdLnInput.taskScripting);
...
function writeFiles() {
      ...
      var tokens = {
            ...
            jsonTaskScript: JSON.stringify(util.setJsonTaskScript(this.taskScripting, this.taskName)),
            commandCompile: this.taskScripting === "TypeScript" ? " && npm run compile " : ""
      }
      ...
      if (this.taskScripting == "PowerShell") {
            ...
            this.fs.copyTpl(
                  ...
                  this.destinationPath(extensionFolder + '/tsconfig.json'), tokens
            );
      }
